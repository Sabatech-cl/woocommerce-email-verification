...
The following is a copy of the readme file from User Email Verification for WooCommerce 3.5.0 by XLPlugins, which is the version we are using as a base. Support the original release.
